...
for img_name in imgfiles:
    img_path = '/home/ubuntu/frames/' + img_name
    ...
    fig.savefig('../caffe_detect_output/'+img_name)
    plt.close(fig)
    take_time = datetime.datetime.now()-start
    print("analysis cost: {}secs, image: {}".format(take_time, img_name))
